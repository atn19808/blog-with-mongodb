...
const uri = "mongodb+srv://" + process.env.CLUSTER_USERNAME + ":" + process.env.CLUSTER_PASSWORD + "@cluster0-vigma.mongodb.net/blogDB";
// console.log(uri);
...
app.get("/posts/:postID", function(req, res) {
  ...
  Post.findById(requestID, function(err, post) {
    if (err) {
      console.log(err);
      res.redirect("/");
    } else {
      console.log("Before logging post using id");
      console.log(post);
      res.render("post", {
        title: post.title,
